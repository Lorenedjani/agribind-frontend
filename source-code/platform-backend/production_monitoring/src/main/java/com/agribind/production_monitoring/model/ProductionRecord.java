...
public class ProductionRecord {
    ...
    @Column(name = "farmer_region", length = 50)
    private String farmerRegion; // Cameroonian region, populated from user-management-service on save

    @Column(name = "farmer_name", length = 255)
    private String farmerName; // Cached farmer name for fast report generation

    public String getFarmerRegion() { return farmerRegion; }
    public void setFarmerRegion(String farmerRegion) { this.farmerRegion = farmerRegion; }
