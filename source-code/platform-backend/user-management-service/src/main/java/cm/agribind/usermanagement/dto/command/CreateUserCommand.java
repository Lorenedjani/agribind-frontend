...
public class CreateUserCommand {
    ...
    /** DB primary key of the cooperative user row */
    private Long cooperativeId;
    /** Business id of the cooperative (e.g. C24669); resolves farmers/managers to the correct coop */
    private String cooperativeUserId;
