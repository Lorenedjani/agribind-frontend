...
export class PlantHealthService {
  ...
  uploadPlantPhoto(plantId: number, file: File, caption?: string, takenAt?: Date): Observable<PlantPhotoResponse> {
    ...
    return this.http.post<PlantPhotoResponse>(`${this.apiUrl}/v1/plants/${plantId}/photos/upload`, formData).pipe(
  ...
  uploadMultiplePhotos(plantId: number, files: File[], caption?: string): Observable<PlantPhotoResponse[]> {
    ...
    return this.http.post<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/${plantId}/photos/batch-upload`, formData).pipe(
  ...
  getPlantPhotos(plantId: number, params: {
    ...
    return this.http.get<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/${plantId}/photos`, { params: httpParams }).pipe(
      catchError(this.handleError('getPlantPhotos', []))
    );
  }

  getPlantPhoto(photoId: number): Observable<PlantPhotoResponse> {
    return this.http.get<PlantPhotoResponse>(`${this.apiUrl}/v1/plants/photos/${photoId}`).pipe(
      catchError(this.handleError<PlantPhotoResponse>('getPlantPhoto'))
    );
  }

  downloadPlantPhoto(photoId: number): Observable<Blob> {
    return this.http.get(`${this.apiUrl}/v1/plants/photos/${photoId}/download`, {
      responseType: 'blob'
    }).pipe(
  ...
  getPlantPhotoImage(photoId: number): Observable<Blob> {
    return this.http.get(`${this.apiUrl}/v1/plants/photos/${photoId}/image`, {
      responseType: 'blob'
    }).pipe(
  ...
  getPlantPhotoThumbnail(photoId: number): Observable<Blob> {
    return this.http.get(`${this.apiUrl}/v1/plants/photos/${photoId}/thumbnail`, {
      responseType: 'blob'
    }).pipe(
  ...
  getPhotoHealthAnalysis(photoId: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/v1/plants/photos/${photoId}/health-analysis`).pipe(
      catchError(this.handleError<any>('getPhotoHealthAnalysis'))
    );
  }

  reprocessHealthAnalysis(photoId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/v1/plants/photos/${photoId}/reprocess`, {}).pipe(
  ...
  searchPhotos(keyword: string, page: number = 0, size: number = 20): Observable<PlantPhotoResponse[]> {
    ...
    return this.http.get<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/photos/search`, { params }).pipe(
  ...
  getPhotosByHealthStatus(status: string, page: number = 0, size: number = 20): Observable<PlantPhotoResponse[]> {
    ...
    return this.http.get<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/photos/health-status/${status}`, { params }).pipe(
  ...
  getPhotosWithDiseases(page: number = 0, size: number = 20): Observable<PlantPhotoResponse[]> {
    ...
    return this.http.get<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/photos/diseases`, { params }).pipe(
  ...
  getRecentPhotos(count: number = 10): Observable<PlantPhotoResponse[]> {
    ...
    return this.http.get<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/photos/recent`, { params }).pipe(
      catchError(this.handleError('getRecentPhotos', []))
    );
  }

  getPhotoStats(plantId: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/v1/plants/${plantId}/photos/stats`).pipe(
  ...
  updatePhotoCaption(photoId: number, caption: string): Observable<PlantPhotoResponse> {
    return this.http.put<PlantPhotoResponse>(`${this.apiUrl}/v1/plants/photos/${photoId}/caption`, { caption }).pipe(
      catchError(this.handleError<PlantPhotoResponse>('updatePhotoCaption'))
    );
  }

  deletePlantPhoto(photoId: number): Observable<void> {
    return this.http.delete(`${this.apiUrl}/v1/plants/photos/${photoId}`).pipe(
  ...
  batchDeletePhotos(photoIds: number[]): Observable<void> {
    return this.http.delete(`${this.apiUrl}/v1/plants/photos/batch-delete`, {
      body: photoIds
    }).pipe(
  ...
  getPhotosByDateRange(startDate: Date, endDate: Date): Observable<PlantPhotoResponse[]> {
    ...
    return this.http.get<PlantPhotoResponse[]>(`${this.apiUrl}/v1/plants/photos/date-range`, { params }).pipe(
  ...
  createPlant(plant: Plant): Observable<Plant> {
    return this.http.post<Plant>(`${this.apiUrl}/v1/plants`, plant).pipe(
      catchError(this.handleError<Plant>('createPlant'))
    );
  }

  getAllPlants(): Observable<Plant[]> {
    return this.http.get<Plant[]>(`${this.apiUrl}/v1/plants`).pipe(
      catchError(this.handleError('getAllPlants', []))
    );
  }

  getPlantById(id: number): Observable<Plant> {
    return this.http.get<Plant>(`${this.apiUrl}/v1/plants/${id}`).pipe(
      catchError(this.handleError<Plant>('getPlantById'))
    );
  }

  updatePlant(id: number, plant: Plant): Observable<Plant> {
    return this.http.put<Plant>(`${this.apiUrl}/v1/plants/${id}`, plant).pipe(
      catchError(this.handleError<Plant>('updatePlant'))
    );
  }

  deletePlant(id: number): Observable<void> {
    return this.http.delete(`${this.apiUrl}/v1/plants/${id}`).pipe(
  ...
  searchPlants(name: string): Observable<Plant[]> {
    ...
    return this.http.get<Plant[]>(`${this.apiUrl}/v1/plants/search`, { params }).pipe(
